...
export const en = {
	...
	settings: {
		...
		counting: {
			...
			ownFolders: "Own folders",
			ownFoldersDesc: "Folders whose notes count as your own thinking, whether or not they carry an own tag.",
			ownFoldersPlaceholder: "e.g. 01. Journal",
			sourceTags: "Source tags",
			sourceTagsDesc: "Tags marking notes about external material.",
			sourceTagsPlaceholder: "e.g. book",
			sourceFolders: "Source folders",
			sourceFoldersDesc: "Folders whose notes count as external material, whether or not they carry a source tag.",
			sourceFoldersPlaceholder: "e.g. 02. Reading",
		...
		folderBreakdown: {
			...
			groupsDesc: 'One row per group. Multiple paths in the same group are comma-separated, e.g. "Areas = 02. Areas, 02b. Health".',
			groupsEmpty: "No groups yet — add one to get a per-group breakdown.",
			addGroup: "Add group",
			groupNamePlaceholder: "Projects",
			groupPathsPlaceholder: "01. Projects, 02. Archive",
		...
		inbox: {
			...
			foldersPlaceholder: "e.g. 00. Inbox",
